...
public class AdministradorSistema {
    ...
    //Cadastra um novo aluno no sistema; verifica se o cpf já existe antes de inserir e lança exceção se duplicado.
    ...
    //Busca e retorna um aluno pelo cpf. Lança exceção se o cpf não estiver cadastrado.
    ...
    //Tenta registrar uma nova reserva. Percorre todas as reservas já existentes verificando sobreposição de horário no mesmo espaço e data; Lança AmbienteIndisponivelException se houver conflito.
    ...
    //Adiciona um serviço adicional a um agendamento existente. Valida se o agendamento existe e se o serviço é válido.
